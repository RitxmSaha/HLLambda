...
# ---- 1. Build the 21-state Markov chain as per the paper ----
...
def run_td_experiment(
    ...
    for run in range(n_runs):
        ...
        state = 10  # Start in the middle, as often done
        rmse_this_run = []
...
def plot_multiple_rmse_curves(results_dict, save_path=None):
    ...
    plt.xlabel("Steps")
    plt.ylabel("RMSE")
    plt.title(f"TD(λ) on 21-state Markov Chain")
    plt.legend()
...
if __name__ == "__main__":
    ...
    plot_multiple_rmse_curves(results, save_path="results/paper_td_alpha_comparison_21.png")
    ...
    print("\nExperiment complete! Check results/paper_td_alpha_comparison_21.png for the comparison plot.")
